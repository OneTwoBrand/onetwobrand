...
export default async function CatalogoConfigPage() {
  ...
  return (
    <>
      <AppBar large eyebrow="Configurações" title="Catálogo" />
      <Topbar eyebrow="Configurações" title="Catálogo" action={<Link href="/mais" className="flex items-center gap-1 text-[11px] font-medium uppercase text-ink-mute hover:text-ink transition-colors"><ChevronLeft size={14} />Configurações</Link>} />
      ...
      <main className="flex-1 px-5 pb-28 pt-3 md:px-9 md:py-8">
        <section className="mx-auto max-w-xl space-y-6">
          ...
          <div className="hidden md:flex items-center gap-2 text-[12px] text-ink-soft">
            ...
            <span>/</span>
            <span className="text-ink font-medium">Catálogo</span>
          </div>
          ...
          <Card pad={20}>
            ...
            <SectionHead eyebrow="Produtos" title="Tamanhos" />
            <div className="mt-3">
              <ProductSizesForm config={config} />
            </div>

            <Divider className="my-6" />

            <SectionHead eyebrow="Produtos" title="Tecidos" />
            <div className="mt-3">
              <ProductFabricsForm config={config} />
            </div>

            <Divider className="my-6" />

            <SectionHead eyebrow="Produtos" title="Categorias" />
            <div className="mt-3">
              <ProductCategoriesForm config={config} />
            </div>

            <Divider className="my-6" />

            <SectionHead eyebrow="Produtos" title="Cores" />
            <div className="mt-3">
              <ProductColorsForm config={config} />
            </div>
          </Card>
