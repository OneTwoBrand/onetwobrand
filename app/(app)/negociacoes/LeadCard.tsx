...
export function LeadCard({ lead, waHref }: Props) {
  ...
  const waMessage = `Olá! Estou retomando o contato sobre a peça *${lead.produto_nome}*${lead.tamanho ? ` (tamanho ${lead.tamanho})` : ''}. Posso ajudar?`;
  const waLink = waHref
    ...
    <Card pad={16}>
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          <p className="font-serif text-[17px] text-ink leading-snug truncate">{lead.produto_nome}</p>
          {lead.tamanho && (
