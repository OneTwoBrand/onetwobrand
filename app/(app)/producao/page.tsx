...
export default function ProducaoPage() {
  return (
    <>
      <AppBar large eyebrow="Produção" title="14 ordens ativas" action={<Button size="sm" icon={<Plus size={14} />}>Nova</Button>} />
      <Topbar eyebrow="Produção" title="14 ordens ativas" action={<Button size="sm" icon={<Plus size={14} />}>Nova OP</Button>} />
